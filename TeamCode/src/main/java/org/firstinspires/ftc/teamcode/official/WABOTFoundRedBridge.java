 ...
 *
 */
@Autonomous(name="WABOTFoundRedBridge", group="WABOT")
public class WABOTFoundRedBridge extends LinearOpMode {
    ...
    private void run(){
        ...
        // DIRECTION: 1 = BRIDGE SIDE, -1 = WALL SIDE
        // SLEEP TIME: 300 = BRIDGE SIDE, 940 = WALL SIDE
